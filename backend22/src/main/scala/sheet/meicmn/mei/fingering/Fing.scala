...
case class Fing(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.fing.Anl
    with _root_.sheet.meicmn.mei.gestural.att.fing.Ges
    with _root_.sheet.meicmn.mei.fingering.att.fing.Log
    with _root_.sheet.meicmn.mei.visual.att.fing.Vis
