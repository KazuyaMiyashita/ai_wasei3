package sheet.meicmn.mei.fingering
...
case class FingGrp(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.finggrp.Anl
    with _root_.sheet.meicmn.mei.gestural.att.finggrp.Ges
    with _root_.sheet.meicmn.mei.fingering.att.finggrp.Log
    with _root_.sheet.meicmn.mei.visual.att.finggrp.Vis
    with _root_.sheet.meicmn.mei.fingering.model.FingeringLike {
