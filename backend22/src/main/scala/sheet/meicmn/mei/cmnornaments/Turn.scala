...
case class Turn(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.turn.Anl
    with _root_.sheet.meicmn.mei.gestural.att.turn.Ges
    with _root_.sheet.meicmn.mei.cmnornaments.att.turn.Log
    with _root_.sheet.meicmn.mei.visual.att.turn.Vis
