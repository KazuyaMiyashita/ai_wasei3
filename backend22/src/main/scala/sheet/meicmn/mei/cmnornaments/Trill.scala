...
case class Trill(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.trill.Anl
    with _root_.sheet.meicmn.mei.gestural.att.trill.Ges
    with _root_.sheet.meicmn.mei.cmnornaments.att.trill.Log
    with _root_.sheet.meicmn.mei.visual.att.trill.Vis
