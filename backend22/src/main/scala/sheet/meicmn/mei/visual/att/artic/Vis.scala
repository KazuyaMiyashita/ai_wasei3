package sheet.meicmn.mei.visual.att.artic
...
trait Vis
    ...
    with _root_.sheet.meicmn.mei.shared.att.PlacementOnStaff
    with _root_.sheet.meicmn.mei.shared.att.PlacementRelEvent
    with _root_.sheet.meicmn.mei.shared.att.StaffLoc
    with _root_.sheet.meicmn.mei.shared.att.staffloc.Pitched
