...
case class ScoreDef(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.scoredef.Anl
    with _root_.sheet.meicmn.mei.gestural.att.scoredef.Ges
    with _root_.sheet.meicmn.mei.shared.att.scoredef.Log
    with _root_.sheet.meicmn.mei.visual.att.scoredef.Vis
    with _root_.sheet.meicmn.mei.shared.model.ScoreDefLike {
