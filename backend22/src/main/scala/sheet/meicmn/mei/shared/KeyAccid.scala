...
case class KeyAccid(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.keyaccid.Anl
    with _root_.sheet.meicmn.mei.gestural.att.keyaccid.Ges
    with _root_.sheet.meicmn.mei.shared.att.keyaccid.Log
    with _root_.sheet.meicmn.mei.visual.att.keyaccid.Vis
    with _root_.sheet.meicmn.mei.shared.model.KeyAccidLike {
