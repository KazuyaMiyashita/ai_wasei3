...
case class Caesura(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.caesura.Anl
    with _root_.sheet.meicmn.mei.gestural.att.caesura.Ges
    with _root_.sheet.meicmn.mei.shared.att.caesura.Log
    with _root_.sheet.meicmn.mei.visual.att.caesura.Vis
