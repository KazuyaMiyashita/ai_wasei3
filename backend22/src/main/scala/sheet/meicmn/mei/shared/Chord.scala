...
case class Chord(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.chord.Anl
    with _root_.sheet.meicmn.mei.gestural.att.chord.Ges
    with _root_.sheet.meicmn.mei.shared.att.chord.Log
    with _root_.sheet.meicmn.mei.visual.att.chord.Vis
