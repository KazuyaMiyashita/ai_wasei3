...
case class Syl(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.syl.Anl
    with _root_.sheet.meicmn.mei.gestural.att.syl.Ges
    with _root_.sheet.meicmn.mei.shared.att.syl.Log
    with _root_.sheet.meicmn.mei.visual.att.syl.Vis
    with _root_.sheet.meicmn.mei.shared.model.SylLike {
