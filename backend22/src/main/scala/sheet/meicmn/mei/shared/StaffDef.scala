...
case class StaffDef(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.staffdef.Anl
    with _root_.sheet.meicmn.mei.gestural.att.staffdef.Ges
    with _root_.sheet.meicmn.mei.shared.att.staffdef.Log
    with _root_.sheet.meicmn.mei.visual.att.staffdef.Vis
    with _root_.sheet.meicmn.mei.shared.model.StaffDefLike {
