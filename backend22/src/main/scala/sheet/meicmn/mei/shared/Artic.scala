...
case class Artic(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.artic.Anl
    with _root_.sheet.meicmn.mei.gestural.att.artic.Ges
    with _root_.sheet.meicmn.mei.shared.att.artic.Log
    with _root_.sheet.meicmn.mei.visual.att.artic.Vis
    with _root_.sheet.meicmn.mei.shared.model.ChordPart
    with _root_.sheet.meicmn.mei.shared.model.NoteModifierLike {
...
object Artic {
  def apply(
      ...
      `artic`: java.lang.String = null,
      `artic.ges`: java.lang.String = null,
