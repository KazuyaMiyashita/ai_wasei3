...
case class Note(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.note.Anl
    with _root_.sheet.meicmn.mei.gestural.att.note.Ges
    with _root_.sheet.meicmn.mei.shared.att.note.Log
    with _root_.sheet.meicmn.mei.visual.att.note.Vis
