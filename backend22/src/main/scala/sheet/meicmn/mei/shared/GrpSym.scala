...
case class GrpSym(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.grpsym.Anl
    with _root_.sheet.meicmn.mei.gestural.att.grpsym.Ges
    with _root_.sheet.meicmn.mei.shared.att.grpsym.Log
    with _root_.sheet.meicmn.mei.visual.att.grpsym.Vis {
