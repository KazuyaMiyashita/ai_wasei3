...
case class Clef(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.clef.Anl
    with _root_.sheet.meicmn.mei.gestural.att.clef.Ges
    with _root_.sheet.meicmn.mei.shared.att.clef.Log
    with _root_.sheet.meicmn.mei.visual.att.clef.Vis
    with _root_.sheet.meicmn.mei.shared.model.EventLike
    with _root_.sheet.meicmn.mei.shared.model.StaffDefPart {
...
object Clef {
  def apply(
      ...
      `cautionary`: java.lang.String = null,
      `class`: java.lang.String = null,
      `color`: java.lang.String = null,
      `copyof`: java.lang.String = null,
      `corresp`: java.lang.String = null,
      `dis`: java.lang.String = null,
      `dis.place`: java.lang.String = null,
