...
case class Phrase(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.phrase.Anl
    with _root_.sheet.meicmn.mei.gestural.att.phrase.Ges
    with _root_.sheet.meicmn.mei.shared.att.phrase.Log
    with _root_.sheet.meicmn.mei.visual.att.phrase.Vis
