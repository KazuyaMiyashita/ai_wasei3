...
case class Dynam(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.dynam.Anl
    with _root_.sheet.meicmn.mei.gestural.att.dynam.Ges
    with _root_.sheet.meicmn.mei.shared.att.dynam.Log
    with _root_.sheet.meicmn.mei.visual.att.dynam.Vis
