...
case class Accid(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.accid.Anl
    with _root_.sheet.meicmn.mei.gestural.att.accid.Ges
    with _root_.sheet.meicmn.mei.shared.att.accid.Log
    with _root_.sheet.meicmn.mei.visual.att.accid.Vis
...
object Accid {
  def apply(
      ...
      `accid.ges`: java.lang.String = null,
