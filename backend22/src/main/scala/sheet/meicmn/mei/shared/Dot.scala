...
case class Dot(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.dot.Anl
    with _root_.sheet.meicmn.mei.gestural.att.dot.Ges
    with _root_.sheet.meicmn.mei.shared.att.dot.Log
    with _root_.sheet.meicmn.mei.visual.att.dot.Vis
