...
case class Verse(
    ...
    with _root_.sheet.meicmn.mei.lyrics.att.verse.Log
    with _root_.sheet.meicmn.mei.visual.att.verse.Vis
    with _root_.sheet.meicmn.mei.gestural.att.verse.Ges
    with _root_.sheet.meicmn.mei.analytical.att.verse.Anl
