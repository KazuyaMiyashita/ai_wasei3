...
case class BeatRpt(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.beatrpt.Log
    with _root_.sheet.meicmn.mei.visual.att.beatrpt.Vis
    with _root_.sheet.meicmn.mei.gestural.att.beatrpt.Ges
    with _root_.sheet.meicmn.mei.analytical.att.beatrpt.Anl
