...
case class MRpt2(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.mrpt2.Log
    with _root_.sheet.meicmn.mei.visual.att.mrpt2.Vis
    with _root_.sheet.meicmn.mei.gestural.att.mrpt2.Ges
    with _root_.sheet.meicmn.mei.analytical.att.mrpt2.Anl
