...
case class MRest(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.mrest.Log
    with _root_.sheet.meicmn.mei.visual.att.mrest.Vis
    with _root_.sheet.meicmn.mei.gestural.att.mrest.Ges
    with _root_.sheet.meicmn.mei.analytical.att.mrest.Anl
    with _root_.sheet.meicmn.mei.cmn.model.eventlike.MeasureFilling {
