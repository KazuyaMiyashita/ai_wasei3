...
case class Tie(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.tie.Log
    with _root_.sheet.meicmn.mei.visual.att.tie.Vis
    with _root_.sheet.meicmn.mei.gestural.att.tie.Ges
    with _root_.sheet.meicmn.mei.analytical.att.tie.Anl
