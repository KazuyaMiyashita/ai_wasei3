...
case class Bend(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.bend.Log
    with _root_.sheet.meicmn.mei.visual.att.bend.Vis
    with _root_.sheet.meicmn.mei.gestural.att.bend.Ges
    with _root_.sheet.meicmn.mei.analytical.att.bend.Anl
