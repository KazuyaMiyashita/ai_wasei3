...
case class HarpPedal(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.harppedal.Log
    with _root_.sheet.meicmn.mei.visual.att.harppedal.Vis
    with _root_.sheet.meicmn.mei.gestural.att.harppedal.Ges
    with _root_.sheet.meicmn.mei.analytical.att.harppedal.Anl
