...
case class Lv(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.lv.Log
    with _root_.sheet.meicmn.mei.visual.att.lv.Vis
    with _root_.sheet.meicmn.mei.gestural.att.lv.Ges
    with _root_.sheet.meicmn.mei.analytical.att.lv.Anl
