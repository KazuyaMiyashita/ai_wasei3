...
case class Gliss(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.gliss.Log
    with _root_.sheet.meicmn.mei.visual.att.gliss.Vis
    with _root_.sheet.meicmn.mei.gestural.att.gliss.Ges
    with _root_.sheet.meicmn.mei.analytical.att.gliss.Anl
