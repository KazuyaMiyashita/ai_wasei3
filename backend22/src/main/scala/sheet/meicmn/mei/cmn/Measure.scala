...
case class Measure(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.measure.Anl
    with _root_.sheet.meicmn.mei.gestural.att.measure.Ges
    with _root_.sheet.meicmn.mei.cmn.att.measure.Log
    with _root_.sheet.meicmn.mei.visual.att.measure.Vis
    with _root_.sheet.meicmn.mei.shared.att.TargetEval
    with _root_.sheet.meicmn.mei.cmn.model.MeasureLike {
...
object Measure {
  def apply(
      `bar.len`: java.lang.String = null,
      `bar.method`: java.lang.String = null,
      `bar.place`: java.lang.String = null,
      ...
      `join`: java.lang.String = null,
      `label`: java.lang.String = null,
      `left`: java.lang.String = null,
      `metcon`: java.lang.String = null,
