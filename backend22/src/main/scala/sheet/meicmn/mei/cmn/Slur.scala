...
case class Slur(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.slur.Log
    with _root_.sheet.meicmn.mei.visual.att.slur.Vis
    with _root_.sheet.meicmn.mei.gestural.att.slur.Ges
    with _root_.sheet.meicmn.mei.analytical.att.slur.Anl
