...
case class Hairpin(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.hairpin.Log
    with _root_.sheet.meicmn.mei.visual.att.hairpin.Vis
    with _root_.sheet.meicmn.mei.gestural.att.hairpin.Ges
    with _root_.sheet.meicmn.mei.analytical.att.hairpin.Anl
