...
case class RepeatMark(
    ...
    with _root_.sheet.meicmn.mei.shared.att.repeatmark.Log
    with _root_.sheet.meicmn.mei.visual.att.repeatmark.Vis
    with _root_.sheet.meicmn.mei.gestural.att.repeatmark.Ges
    with _root_.sheet.meicmn.mei.analytical.att.repeatmark.Anl
