...
case class MNum(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.mnum.Log
    with _root_.sheet.meicmn.mei.visual.att.mnum.Vis
    with _root_.sheet.meicmn.mei.gestural.att.mnum.Ges
    with _root_.sheet.meicmn.mei.analytical.att.mnum.Anl {
