...
case class BracketSpan(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.bracketspan.Log
    with _root_.sheet.meicmn.mei.visual.att.bracketspan.Vis
    with _root_.sheet.meicmn.mei.gestural.att.bracketspan.Ges
    with _root_.sheet.meicmn.mei.analytical.att.bracketspan.Anl
