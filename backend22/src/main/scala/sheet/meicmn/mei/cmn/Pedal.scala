...
case class Pedal(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.pedal.Log
    with _root_.sheet.meicmn.mei.visual.att.pedal.Vis
    with _root_.sheet.meicmn.mei.gestural.att.pedal.Ges
    with _root_.sheet.meicmn.mei.analytical.att.pedal.Anl
