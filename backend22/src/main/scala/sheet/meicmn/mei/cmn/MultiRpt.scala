...
case class MultiRpt(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.multirpt.Log
    with _root_.sheet.meicmn.mei.visual.att.multirpt.Vis
    with _root_.sheet.meicmn.mei.gestural.att.multirpt.Ges
    with _root_.sheet.meicmn.mei.analytical.att.multirpt.Anl
