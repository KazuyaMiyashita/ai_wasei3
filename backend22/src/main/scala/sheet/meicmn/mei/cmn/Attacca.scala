...
case class Attacca(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.attacca.Anl
    with _root_.sheet.meicmn.mei.gestural.att.attacca.Ges
    with _root_.sheet.meicmn.mei.shared.att.attacca.Log
    with _root_.sheet.meicmn.mei.visual.att.attacca.Vis
    with _root_.sheet.meicmn.mei.cmn.model.controleventlike.Cmn {
