...
case class Octave(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.octave.Log
    with _root_.sheet.meicmn.mei.visual.att.octave.Vis
    with _root_.sheet.meicmn.mei.gestural.att.octave.Ges
    with _root_.sheet.meicmn.mei.analytical.att.octave.Anl
