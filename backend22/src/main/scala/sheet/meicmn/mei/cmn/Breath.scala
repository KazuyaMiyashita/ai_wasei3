...
case class Breath(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.breath.Log
    with _root_.sheet.meicmn.mei.visual.att.breath.Vis
    with _root_.sheet.meicmn.mei.gestural.att.breath.Ges
    with _root_.sheet.meicmn.mei.analytical.att.breath.Anl
