...
case class MRpt(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.mrpt.Log
    with _root_.sheet.meicmn.mei.visual.att.mrpt.Vis
    with _root_.sheet.meicmn.mei.gestural.att.mrpt.Ges
    with _root_.sheet.meicmn.mei.analytical.att.mrpt.Anl
