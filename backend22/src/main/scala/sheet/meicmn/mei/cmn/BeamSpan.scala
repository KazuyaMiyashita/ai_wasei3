...
case class BeamSpan(
    ...
    with _root_.sheet.meicmn.mei.cmn.att.beamspan.Log
    with _root_.sheet.meicmn.mei.visual.att.beamspan.Vis
    with _root_.sheet.meicmn.mei.gestural.att.beamspan.Ges
    with _root_.sheet.meicmn.mei.analytical.att.beamspan.Anl
...
object BeamSpan {
  def apply(
      ...
      `slash`: java.lang.String = null,
      `slope`: java.lang.String = null,
