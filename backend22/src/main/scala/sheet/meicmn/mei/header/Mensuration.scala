package sheet.meicmn.mei.header
...
case class Mensuration(
    ...
    with _root_.sheet.meicmn.mei.shared.att.mensur.Log
    with _root_.sheet.meicmn.mei.visual.att.mensur.Vis
