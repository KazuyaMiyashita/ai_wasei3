package sheet.meicmn.mei.drama
...
case class StageDir(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.stagedir.Anl
    with _root_.sheet.meicmn.mei.gestural.att.stagedir.Ges
    with _root_.sheet.meicmn.mei.drama.att.stagedir.Log
    with _root_.sheet.meicmn.mei.visual.att.stagedir.Vis
    with _root_.sheet.meicmn.mei.drama.model.StageDirLike {
