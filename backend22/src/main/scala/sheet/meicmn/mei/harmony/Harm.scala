...
case class Harm(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.harm.Anl
    with _root_.sheet.meicmn.mei.gestural.att.harm.Ges
    with _root_.sheet.meicmn.mei.harmony.att.harm.Log
    with _root_.sheet.meicmn.mei.visual.att.harm.Vis
    with _root_.sheet.meicmn.mei.harmony.model.HarmLike {
