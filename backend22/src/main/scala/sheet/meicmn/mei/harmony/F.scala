package sheet.meicmn.mei.harmony
...
case class F(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.f.Anl
    with _root_.sheet.meicmn.mei.gestural.att.f.Ges
    with _root_.sheet.meicmn.mei.harmony.att.f.Log
    with _root_.sheet.meicmn.mei.visual.att.f.Vis
    with _root_.sheet.meicmn.mei.harmony.model.FLike {
