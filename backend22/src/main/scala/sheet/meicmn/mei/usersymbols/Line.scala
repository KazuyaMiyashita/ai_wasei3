...
case class Line(
    ...
    with _root_.sheet.meicmn.mei.analytical.att.line.Anl
    with _root_.sheet.meicmn.mei.gestural.att.line.Ges
    with _root_.sheet.meicmn.mei.usersymbols.att.line.Log
    with _root_.sheet.meicmn.mei.visual.att.line.Vis
